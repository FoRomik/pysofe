...
element method is creating a mesh to discretize that domain of the
...
define or generate the nodes and cells and then use refinement methods
to get a good discretization this approach becomes infeasible once the
geometries get more complicated.
...
They make use of the analogy between a simplical mesh and a truss
